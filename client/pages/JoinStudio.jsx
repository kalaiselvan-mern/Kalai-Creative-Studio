        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            {socialLinks.map((social) => (
              <a key={social.id} href={social.url} target="_blank" rel="noreferrer" className={`p-3 rounded-xl border ${social.neon} bg-gray-900 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_20px_currentColor]`}>
                {social.icon}
              </a>
            ))}
          </div>
